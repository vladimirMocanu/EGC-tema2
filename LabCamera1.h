	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				glm::mat4  mat = glm::rotate(glm::mat4(1.0f), angle, right);
				glm::vec4 newVec = glm::vec4(forward, 0.0);
				newVec = mat * newVec;
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				newVec = mat * newVec;
				forward = glm::normalize(glm::vec3(newVec));
				glm::vec4 newVect = glm::vec4(right, 0.0);
				newVect = mat * newVect;
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				glm::mat4  mat = glm::rotate(glm::mat4(1.0f), angle, forward);
				glm::vec4 newVec = glm::vec4(right, 0.0);
				newVec = mat * newVec;
